...
const ThemeSection = () => {
  ...
  return (
    <div className="bg-black text-white">
      <div ref={sectionRef} id="theme-section" className="flex flex-col items-center justify-center p-8">
       
        <h1 className= "text-6xl font-extrabold text-red-900 text-center">
          Theme 2025
        </h1>

        <motion.p className="mt-4 max-w-3xl text-gray-300 text-center leading-relaxed overflow-hidden relative">
          <motion.span
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 mt-8">
          ...
          <div className="p-4 bg-red-700 rounded-xl shadow-lg md:w-3/5 h-28 flex flex-col justify-center transform transition duration-300 hover:scale-105 hover:shadow-xl">
