...
const SpeakersTimeline = () => {
  ...
  */
    ...
    { 
      ...
      topic: "", 
      image: speaker11,
      about: "Raktim Singh has done B.TECH from IIT BHU. He is working in Infosys, FINACLE from 1995 onwards. He has deep proficiency in Artificial Intelligence, AI research & analysis and digital banking strategy & FinTech. He is author of the Amazon Best Seller 'Driving Digital transformation' (sold in 25+ countries). THis TEDx talk ‘How Digital Transformation will help common person’ was widely appreciated. He is a keynote speaker & spoken on various industry & university events on topics related to digital technologies including GEN AI, AI in Banking, AI for common person. He has published numerous Thought Papers on Advance Technologies usages & trends, Future Technology Trends, Role of Artificial Intelligence in various sectors. He also regularly writes on global online platform Finxtra & numerous other online platforms. He has his own website www.raktimsingh.com, where he regularly writes on topics related to various digital technologies (Artificial Intelligence, Quantum AI, Data, cloud, Blockchain, Metaverse..) & usage of these technologies in various sectors. Now his website contains 150+ articles. His articles had been published in various magazines like, Fortune, US Times Now, International Business times, Deccan Chronicle, Business Standard etc. He also mentor IIM & IIT graduates. He is well connected with global leaders on Artificial Intelligence and regularly contributes though his LinkedIn www.linkedin.com/raktimsingh. He has been recognized as ‘Top Thought Leadership Voice’ & ‘Top Artificial Intelligence Voice’. He has his own YouTube Channel (with 100,000+ subscribers) where he regularly shares videos related to AI, GEN AI & other technology. His aim is help and educate common person about various new technologies & how they can benefit from those. One can watch YouTube channel at  https://www.youtube.com/@raktim_hindi."
    },
    { 
      id: 11, 
      name: "Bhavana Govil", 
