...
const ToBeAnnounced = () => {
  const calculateTimeLeft = () => {
    const targetDate = new Date("2025-04-25T00:00:00"); // Adjust the date here
    const now = new Date();
  ...
  return (
    <div className="relative h-screen flex items-center justify-center bg-black text-white">
      ...
      <h1 className="text-center text-6xl md:text-8xl mb-10 text-red-800 p-3 ">Voices That Inspire</h1>
        <p className="text-gray-300 text-lg tracking-widest">TO BE ANNOUNCED</p>
        <h1 className="text-6xl md:text-8xl font-bold tracking-wider">COMING <span className="text-red-800"> SOON</span></h1>
